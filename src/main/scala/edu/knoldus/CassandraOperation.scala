...
object CassandraOperation extends App with CassandraProviders {
  ...
  private def getUsersAllDetails(inSession: Session): Unit = {
    ...
    println("....................Fetching the data for a particular emp_id.................................")
    ...
    println("\n.................Updating record  with id as 1 and salary as 50000 to have the emp_city as chandigarh.............")
    inSession.execute(s"update employee set emp_city = 'Chandigarh' where emp_id = 1 and emp_salary = 50000;")
    println("Row is updated")
    ...
    println("\n...............Fetching the data for the records having salary > 30000 and id = 1.............")
    ...
    println("\n...................Fetching the details of all the employees who live in chandigarh....................")
  ...
  private def deleteUserLivingInChandigarh(inSession: Session): Unit = {
    ...
    println(".......................................................")
    inSession.execute(s"create table IF NOT EXISTS emprecord(emp_id int,emp_name text,emp_city text,emp_salary varint,emp_phone varint,primary key(emp_city));")
    inSession.execute(s"insert into emprecord(emp_id, emp_name, emp_city, emp_salary, emp_phone) values(1,'Bhawna','Chandigarh',50000,9876543210);")
    inSession.execute(s"insert into emprecord(emp_id, emp_name, emp_city, emp_salary, emp_phone) values(2,'Gaurav','Noida',100000,9898993210);")
    inSession.execute(s"delete from emprecord where emp_city = 'Chandigarh';")
    println(s"....deletion done....")
    val result5 = inSession.execute(s"select * from emprecord;").asScala.toList
